...
#[function_component(NoEncryptionGmailerrorredSharp)]
pub fn no_encryption_gmailerrorred_sharp(props: &Props) -> Html {
    let new_props = Props{
        icon: From::from("NoEncryptionGmailerrorredSharp"),
        ..props.clone()
    };
