...
#[function_component(SentimentVeryDissatisfiedSharp)]
pub fn sentiment_very_dissatisfied_sharp(props: &Props) -> Html {
    let new_props = Props{
        icon: From::from("SentimentVeryDissatisfiedSharp"),
        ..props.clone()
    };
