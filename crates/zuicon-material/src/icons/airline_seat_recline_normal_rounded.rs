...
#[function_component(AirlineSeatReclineNormalRounded)]
pub fn airline_seat_recline_normal_rounded(props: &Props) -> Html {
    let new_props = Props{
        icon: From::from("AirlineSeatReclineNormalRounded"),
        ..props.clone()
    };
