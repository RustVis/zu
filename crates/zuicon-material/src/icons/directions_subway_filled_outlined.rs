...
#[function_component(DirectionsSubwayFilledOutlined)]
pub fn directions_subway_filled_outlined(props: &Props) -> Html {
    let new_props = Props{
        icon: From::from("DirectionsSubwayFilledOutlined"),
        ..props.clone()
    };
