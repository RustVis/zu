...
#[function_component(PlaylistAddCheckCircleOutlined)]
pub fn playlist_add_check_circle_outlined(props: &Props) -> Html {
    let new_props = Props{
        icon: From::from("PlaylistAddCheckCircleOutlined"),
        ..props.clone()
    };
