...
#[function_component(PanoramaPhotosphereSelectRounded)]
pub fn panorama_photosphere_select_rounded(props: &Props) -> Html {
    let new_props = Props{
        icon: From::from("PanoramaPhotosphereSelectRounded"),
        ..props.clone()
    };
