...
#[function_component(SwitchAccessShortcutAddOutlined)]
pub fn switch_access_shortcut_add_outlined(props: &Props) -> Html {
    let new_props = Props{
        icon: From::from("SwitchAccessShortcutAddOutlined"),
        ..props.clone()
    };
