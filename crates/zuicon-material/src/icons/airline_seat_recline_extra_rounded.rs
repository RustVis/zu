...
#[function_component(AirlineSeatReclineExtraRounded)]
pub fn airline_seat_recline_extra_rounded(props: &Props) -> Html {
    let new_props = Props{
        icon: From::from("AirlineSeatReclineExtraRounded"),
        ..props.clone()
    };
