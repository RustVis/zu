...
#[function_component(NoEncryptionGmailerrorredTwoTone)]
pub fn no_encryption_gmailerrorred_two_tone(props: &Props) -> Html {
    let new_props = Props{
        icon: From::from("NoEncryptionGmailerrorredTwoTone"),
        ..props.clone()
    };
