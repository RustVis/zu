...
#[function_component(PanoramaWideAngleSelectTwoTone)]
pub fn panorama_wide_angle_select_two_tone(props: &Props) -> Html {
    let new_props = Props{
        icon: From::from("PanoramaWideAngleSelectTwoTone"),
        ..props.clone()
    };
