...
#[function_component(DoNotDisturbOnTotalSilenceRounded)]
pub fn do_not_disturb_on_total_silence_rounded(props: &Props) -> Html {
    let new_props = Props{
        icon: From::from("DoNotDisturbOnTotalSilenceRounded"),
        ..props.clone()
    };
