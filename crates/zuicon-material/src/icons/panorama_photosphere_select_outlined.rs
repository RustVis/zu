...
#[function_component(PanoramaPhotosphereSelectOutlined)]
pub fn panorama_photosphere_select_outlined(props: &Props) -> Html {
    let new_props = Props{
        icon: From::from("PanoramaPhotosphereSelectOutlined"),
        ..props.clone()
    };
