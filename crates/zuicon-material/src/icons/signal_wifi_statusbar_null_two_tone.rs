...
#[function_component(SignalWifiStatusbarNullTwoTone)]
pub fn signal_wifi_statusbar_null_two_tone(props: &Props) -> Html {
    let new_props = Props{
        icon: From::from("SignalWifiStatusbarNullTwoTone"),
        ..props.clone()
    };
