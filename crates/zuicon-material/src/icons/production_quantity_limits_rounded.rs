...
#[function_component(ProductionQuantityLimitsRounded)]
pub fn production_quantity_limits_rounded(props: &Props) -> Html {
    let new_props = Props{
        icon: From::from("ProductionQuantityLimitsRounded"),
        ..props.clone()
    };
