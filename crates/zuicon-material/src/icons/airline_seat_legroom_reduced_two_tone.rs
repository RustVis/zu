...
#[function_component(AirlineSeatLegroomReducedTwoTone)]
pub fn airline_seat_legroom_reduced_two_tone(props: &Props) -> Html {
    let new_props = Props{
        icon: From::from("AirlineSeatLegroomReducedTwoTone"),
        ..props.clone()
    };
