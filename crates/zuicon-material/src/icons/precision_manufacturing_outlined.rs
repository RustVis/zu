...
#[function_component(PrecisionManufacturingOutlined)]
pub fn precision_manufacturing_outlined(props: &Props) -> Html {
    let new_props = Props{
        icon: From::from("PrecisionManufacturingOutlined"),
        ..props.clone()
    };
