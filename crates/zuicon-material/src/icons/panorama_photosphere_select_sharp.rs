...
#[function_component(PanoramaPhotosphereSelectSharp)]
pub fn panorama_photosphere_select_sharp(props: &Props) -> Html {
    let new_props = Props{
        icon: From::from("PanoramaPhotosphereSelectSharp"),
        ..props.clone()
    };
