...
#[function_component(AirlineSeatLegroomNormalOutlined)]
pub fn airline_seat_legroom_normal_outlined(props: &Props) -> Html {
    let new_props = Props{
        icon: From::from("AirlineSeatLegroomNormalOutlined"),
        ..props.clone()
    };
