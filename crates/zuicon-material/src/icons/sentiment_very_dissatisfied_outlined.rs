...
#[function_component(SentimentVeryDissatisfiedOutlined)]
pub fn sentiment_very_dissatisfied_outlined(props: &Props) -> Html {
    let new_props = Props{
        icon: From::from("SentimentVeryDissatisfiedOutlined"),
        ..props.clone()
    };
