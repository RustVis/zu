...
#[function_component(SignalWifiStatusbarNullOutlined)]
pub fn signal_wifi_statusbar_null_outlined(props: &Props) -> Html {
    let new_props = Props{
        icon: From::from("SignalWifiStatusbarNullOutlined"),
        ..props.clone()
    };
