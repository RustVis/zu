...
#[function_component(SystemSecurityUpdateWarningTwoTone)]
pub fn system_security_update_warning_two_tone(props: &Props) -> Html {
    let new_props = Props{
        icon: From::from("SystemSecurityUpdateWarningTwoTone"),
        ..props.clone()
    };
