...
#[function_component(PanoramaHorizontalSelectRounded)]
pub fn panorama_horizontal_select_rounded(props: &Props) -> Html {
    let new_props = Props{
        icon: From::from("PanoramaHorizontalSelectRounded"),
        ..props.clone()
    };
