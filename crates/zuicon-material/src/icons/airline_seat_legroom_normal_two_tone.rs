...
#[function_component(AirlineSeatLegroomNormalTwoTone)]
pub fn airline_seat_legroom_normal_two_tone(props: &Props) -> Html {
    let new_props = Props{
        icon: From::from("AirlineSeatLegroomNormalTwoTone"),
        ..props.clone()
    };
