...
#[function_component(ProductionQuantityLimitsTwoTone)]
pub fn production_quantity_limits_two_tone(props: &Props) -> Html {
    let new_props = Props{
        icon: From::from("ProductionQuantityLimitsTwoTone"),
        ..props.clone()
    };
