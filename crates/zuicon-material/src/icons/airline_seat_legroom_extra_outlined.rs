...
#[function_component(AirlineSeatLegroomExtraOutlined)]
pub fn airline_seat_legroom_extra_outlined(props: &Props) -> Html {
    let new_props = Props{
        icon: From::from("AirlineSeatLegroomExtraOutlined"),
        ..props.clone()
    };
