...
#[function_component(FormatTextdirectionRToLOutlined)]
pub fn format_textdirection_r_to_l_outlined(props: &Props) -> Html {
    let new_props = Props{
        icon: From::from("FormatTextdirectionRToLOutlined"),
        ..props.clone()
    };
