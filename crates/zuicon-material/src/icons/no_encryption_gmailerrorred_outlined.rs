...
#[function_component(NoEncryptionGmailerrorredOutlined)]
pub fn no_encryption_gmailerrorred_outlined(props: &Props) -> Html {
    let new_props = Props{
        icon: From::from("NoEncryptionGmailerrorredOutlined"),
        ..props.clone()
    };
