...
#[function_component(SwitchAccessShortcutAddTwoTone)]
pub fn switch_access_shortcut_add_two_tone(props: &Props) -> Html {
    let new_props = Props{
        icon: From::from("SwitchAccessShortcutAddTwoTone"),
        ..props.clone()
    };
