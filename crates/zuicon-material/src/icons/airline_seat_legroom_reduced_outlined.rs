...
#[function_component(AirlineSeatLegroomReducedOutlined)]
pub fn airline_seat_legroom_reduced_outlined(props: &Props) -> Html {
    let new_props = Props{
        icon: From::from("AirlineSeatLegroomReducedOutlined"),
        ..props.clone()
    };
