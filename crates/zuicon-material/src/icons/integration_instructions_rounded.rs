...
#[function_component(IntegrationInstructionsRounded)]
pub fn integration_instructions_rounded(props: &Props) -> Html {
    let new_props = Props{
        icon: From::from("IntegrationInstructionsRounded"),
        ..props.clone()
    };
