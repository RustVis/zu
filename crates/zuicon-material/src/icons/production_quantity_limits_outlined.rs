...
#[function_component(ProductionQuantityLimitsOutlined)]
pub fn production_quantity_limits_outlined(props: &Props) -> Html {
    let new_props = Props{
        icon: From::from("ProductionQuantityLimitsOutlined"),
        ..props.clone()
    };
