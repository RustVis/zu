...
#[function_component(SwitchAccessShortcutAddRounded)]
pub fn switch_access_shortcut_add_rounded(props: &Props) -> Html {
    let new_props = Props{
        icon: From::from("SwitchAccessShortcutAddRounded"),
        ..props.clone()
    };
